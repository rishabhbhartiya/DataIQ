...
=======================================
Reads the DataIQ analysis result and emits a complete, copy-pasteable
...
class PipelineCodeGenerator:
    """
    Generate a complete sklearn Pipeline script from a DataIQ analysis dict.
    ...
    def _header(self) -> str:
        ...
        return textwrap.dedent(f"""\
            ...
            ==============================================
            Generated by  : DataIQ PipelineCodeGenerator
    ...
    def _column_lists(self) -> str:
        lines = [
            "# ── Column Lists (auto-detected by DataIQ) "
            + "─" * 34,
